 ...
 */
package com.text.messages.sms.emoji.migration

import android.content.Context
import com.text.messages.sms.emoji.blocking.QksmsBlockingClient
import com.text.messages.sms.emoji.common.util.extensions.versionCode
...
class QkMigration @Inject constructor(
    ...
    private fun upgradeTo370() {
        ...
        // Migrate blocked conversations into Messages blocking client
