 ...
 */
package com.text.messages.sms.emoji.manager
...
//            val changelogs = inputStream.bufferedReader().use { it.readText() }
//                .let(adapter::fromJson)
//                .orEmpty()
//                .sortedBy { changelog -> changelog.versionCode }
//                .filter { changelog ->
//                    changelog.versionCode in prefs.changelogVersion.get()
//                        .inc()..context.versionCode
//                }
//
