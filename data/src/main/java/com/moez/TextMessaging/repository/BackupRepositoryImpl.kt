...
import com.text.messages.sms.emoji.util.QkFileObserver
...
class BackupRepositoryImpl @Inject constructor(
    ...
    companion object {
        //private val BACKUP_DIRECTORY = Environment.getExternalStorageDirectory().toString() + "/Messages/Backups"
        private val BACKUP_DIRECTORY = if (Build.VERSION.SDK_INT > Build.VERSION_CODES.Q) {
            Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)
                .toString() + "/Messages/Backups"
        } else {
            Environment.getExternalStorageDirectory().toString() + "/Messages/Backups"
        }
    }
    ...
    override fun getBackups(): Observable<List<BackupFile>> =
        QkFileObserver(BACKUP_DIRECTORY).observable
