...
interface ConversationRepository {
    ...
    fun searchConversationsByNumber(): RealmResults<Conversation>
    ...
    fun getThreadId(recipients: Collection<String>, isRefreshNeed: Boolean): Long?
    ...
    fun getOrCreateConversationWithoutRefresh(addresses: List<String>): Conversation?
