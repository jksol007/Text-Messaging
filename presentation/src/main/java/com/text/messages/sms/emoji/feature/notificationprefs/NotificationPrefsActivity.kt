 ...
 */
package com.text.messages.sms.emoji.feature.notificationprefs
...
class NotificationPrefsActivity : MessagesThemedActivity(), NotificationPrefsView {

    @Inject lateinit var previewModeDialog: MessagesDialog
    @Inject lateinit var actionsDialog: MessagesDialog
    ...
    override fun render(state: NotificationPrefsState) {
        ...
        qkreplyDivider.isVisible = false
        qkreplyTitle.isVisible = false
        qkreply.checkbox.isChecked = state.qkReplyEnabled
        qkreply.isVisible = false
        qkreplyTapDismiss.isVisible = false
