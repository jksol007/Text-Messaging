...
import com.text.messages.sms.emoji.feature.conversationinfo.ConversationInfoItem.*
...
class ConversationInfoAdapter @Inject constructor(
...
) : MessagesAdapter<ConversationInfoItem>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MessagesViewHolder {
        ...
        return when (viewType) {
            0 -> MessagesViewHolder(inflater.inflate(R.layout.conversation_recipient_list_item, parent, false)).apply {
            ...
            1 -> MessagesViewHolder(inflater.inflate(R.layout.conversation_info_settings, parent, false)).apply {
            ...
            2 -> MessagesViewHolder(inflater.inflate(R.layout.conversation_media_list_item, parent, false)).apply {
                itemView.setOnClickListener {
    ...
    override fun onBindViewHolder(holder: MessagesViewHolder, position: Int) {
        when (val item = getItem(position)) {
            is ConversationInfoRecipient -> {
                ...
                holder.add.setVisible(false)

                val theme = colors.theme(recipient)
                //holder.theme.setTint(theme.theme)
                holder.theme.setTint(context.resources.getColor(R.color.tools_theme),false)
            }
            ...
            is ConversationInfoSettings -> {
                ...
                Log.i("TAG", "onBindViewHolder: item.blocked:- "+item.blocked)
