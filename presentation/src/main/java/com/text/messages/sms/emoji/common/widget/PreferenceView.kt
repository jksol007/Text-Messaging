...
import com.text.messages.sms.emoji.common.util.extensions.resolveThemeAttribute
import com.text.messages.sms.emoji.common.util.extensions.resolveThemeColorStateList
...
class PreferenceView  constructor(
    ...
    init {
        ...
        context.obtainStyledAttributes(attrs, R.styleable.PreferenceView).run {
            ...
            getResourceId(R.styleable.PreferenceView_icon, -1).takeIf { it != -1 }?.let { id ->
                ...
                icon.setTint(R.color.tools_theme,true)
            }
