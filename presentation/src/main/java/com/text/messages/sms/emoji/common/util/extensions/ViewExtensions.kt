 ...
 */
package com.text.messages.sms.emoji.common.util.extensions
...
fun ImageView.setTint(color: Int, setting: Boolean) {
    imageTintList = if (setting){
        ColorStateList.valueOf(context.resources.getColor(R.color.tools_theme))
    }else{
        ColorStateList.valueOf(color)
    }
    //imageTintList = ColorStateList.valueOf(context.resources.getColor(R.color.tools_theme))
...
fun ProgressBar.setTint(color: Int) {
    ...
    indeterminateTintList = ColorStateList.valueOf(context.resources.getColor(R.color.tools_theme))
    progressTintList = ColorStateList.valueOf(context.resources.getColor(R.color.tools_theme))
}
...
fun View.setBackgroundTint(color: Int) {
    ...
    /*if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP_MR1) {
        background?.setColorFilter(context.resources.getColor(R.color.tools_theme), PorterDuff.Mode.SRC_IN)
    }*/

    backgroundTintList = ColorStateList.valueOf(color)
    //backgroundTintList = ColorStateList.valueOf(context.resources.getColor(R.color.tools_theme))
}
