 ...
 */
package com.text.messages.sms.emoji.feature.changelog
...
import com.text.messages.sms.emoji.manager.ChangelogManager
import kotlinx.android.synthetic.main.changelog_list_item.*

class ChangelogAdapter(private val context: Context) : MessagesAdapter<ChangelogAdapter.ChangelogItem>() {
