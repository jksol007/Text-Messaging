...
class MenuItemAdapter @Inject constructor(private val context: Context, private val colors: Colors) : MessagesAdapter<MenuItem>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MessagesViewHolder {
        ...
        view.check.imageTintList = ColorStateList(states, intArrayOf(context.resources.getColor(R.color.tools_theme), text))
