 ...
 */
package com.text.messages.sms.emoji.feature.scheduled
...
class ScheduledActivity : MessagesThemedActivity(), ScheduledView {

    @Inject lateinit var dialog: MessagesDialog
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        colors.theme().let { theme ->
            ...
            sampleMessage.setBackgroundTint(resources.getColor(R.color.tools_theme))
            sampleMessage.setTextColor(theme.textPrimary)
            //compose.setTint(theme.textPrimary)
            //compose.setBackgroundTint(theme.theme)
            compose.setBackgroundTint(resources.getColor(R.color.tools_theme))
            //upgrade.setBackgroundTint(theme.theme)
            upgrade.setBackgroundTint(resources.getColor(R.color.tools_theme))
            upgradeIcon.setTint(theme.textPrimary,false)
