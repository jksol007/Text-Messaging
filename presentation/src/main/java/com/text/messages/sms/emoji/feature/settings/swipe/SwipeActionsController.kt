 ...
 */
package com.text.messages.sms.emoji.feature.settings.swipe
...
class SwipeActionsController :
    MessagesController<SwipeActionsView, SwipeActionsState, SwipeActionsPresenter>(), SwipeActionsView {

    @Inject
    override lateinit var presenter: SwipeActionsPresenter
    @Inject
    lateinit var actionsDialog: MessagesDialog
    @Inject
    ...
    override fun onViewCreated() {
        colors.theme().let { theme ->
            ...
            rightIcon.setBackgroundTint(resources!!.getColor(R.color.tools_theme))
            rightIcon.setTint(theme.textPrimary, false)
            //leftIcon.setBackgroundTint(theme.theme)
            leftIcon.setBackgroundTint(resources!!.getColor(R.color.tools_theme))
            leftIcon.setTint(theme.textPrimary, false)
        }
