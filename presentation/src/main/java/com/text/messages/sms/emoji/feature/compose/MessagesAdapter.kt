...
import com.text.messages.sms.emoji.common.util.TextViewStyler
...
import com.text.messages.sms.emoji.feature.compose.BubbleUtils.getBubble
import com.text.messages.sms.emoji.feature.compose.part.PartsAdapter
...
class MessagesAdapter @Inject constructor(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MessagesViewHolder {
        ...
        if (viewType == VIEW_TYPE_MESSAGE_OUT) {
            ...
            view.findViewById<ImageView>(R.id.cancelIcon)
                .setTint(context.resources.getColor(R.color.tools_theme), false)
            view.findViewById<ProgressBar>(R.id.cancel)
                .setTint(context.resources.getColor(R.color.tools_theme))
        } else {
    ...
    override fun onBindViewHolder(holder: MessagesViewHolder, position: Int) {
        ...
        if (message.emojiOnly == -1) {
            emojiOnly = messageText.isNotBlank() && messageText.matches(EMOJI_REGEX)
            messageRepo.updateIsEmoji(message.id, emojiOnly)
        } else {
            emojiOnly = message.emojiOnly != 0
        }
    ...
    private fun bindStatus(holder: MessagesViewHolder, message: Message, next: Message?) {
