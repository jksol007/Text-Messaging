...
import com.text.messages.sms.emoji.interactor.DeleteOldMessages
import com.text.messages.sms.emoji.interactor.SyncMessages
...
import com.text.messages.sms.emoji.service.AutoDeleteService
...
class SettingsPresenter @Inject constructor(
...
) : MessagesPresenter<SettingsView, SettingsState>(
    SettingsState(
    ...
    init {
        ...
        disposables += colors.themeObservable()
            .subscribe { theme -> newState {
                copy(theme = theme.theme)
            } }
