...
import com.text.messages.sms.emoji.extensions.associateByNotNull
import com.text.messages.sms.emoji.model.Contact
import com.text.messages.sms.emoji.model.ContactGroup
...
class ComposeItemAdapter @Inject constructor(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MessagesViewHolder {
        ...
        view.icon.setTint(parent.context.resources.getColor(R.color.tools_theme),false)
    ...
    private fun bindNew(holder: MessagesViewHolder, contact: Contact) {
    ...
    private fun bindRecent(holder: MessagesViewHolder, conversation: Conversation, prev: ComposeItem?) {
        holder.index.isVisible = false
    ...
    private fun bindStarred(holder: MessagesViewHolder, contact: Contact, prev: ComposeItem?) {
        holder.index.isVisible = false
    ...
    private fun bindGroup(holder: MessagesViewHolder, group: ContactGroup, prev: ComposeItem?) {
        holder.index.isVisible = false
    ...
    private fun bindPerson(holder: MessagesViewHolder, contact: Contact, prev: ComposeItem?) {
