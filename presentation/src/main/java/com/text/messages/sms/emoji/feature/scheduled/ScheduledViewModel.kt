...
import com.text.messages.sms.emoji.interactor.SendScheduledMessage
import com.text.messages.sms.emoji.manager.BillingManager
import com.text.messages.sms.emoji.repository.ScheduledMessageRepository
...
class ScheduledViewModel @Inject constructor(
...
) : MessagesViewModel<ScheduledView, ScheduledState>(ScheduledState(
    ...
    override fun bindView(view: ScheduledView) {
        ...
        view.composeIntent
            .autoDispose(view.scope())
            .subscribe { navigator.showComposeCheck(true) }
