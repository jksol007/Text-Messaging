...
import com.text.messages.sms.emoji.common.util.extensions.getLabel
import com.text.messages.sms.emoji.common.util.extensions.setBackgroundTint
import com.text.messages.sms.emoji.common.util.extensions.setPositiveButton
...
class BackupController : MessagesController<BackupView, BackupState, BackupPresenter>(), BackupView {
    ...
    private val stopRestoreDialog by lazy {
        ...
        MaterialAlertDialogBuilder(
            ...
            .setMessage(R.string.backup_restore_stop_message)
            .setPositiveButton(R.string.button_stop) { _, _ -> stopRestoreSubject }
            .setNegativeButton(R.string.button_cancel) { _, _ -> null }
            .create()
    }
    ...
    override fun onViewCreated() {
        ...
        themedActivity?.colors?.theme()?.let { theme ->
            ...
            fab.setBackgroundTint(resources!!.getColor(R.color.tools_theme))
            fabIcon.setTint(theme.textPrimary, false)
