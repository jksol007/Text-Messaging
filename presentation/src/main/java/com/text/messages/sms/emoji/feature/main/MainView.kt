...
interface MainView : MessagesView<MainState> {
    ...
    val languageIntent: Observable<Unit>
    ...
    fun setMenuBackground(isMenu : Boolean)
}

enum class NavItem { BACK, INBOX, ARCHIVED, BACKUP, SCHEDULED, BLOCKING, SETTINGS, PLUS, HELP, INVITE, PRIVACY_POLICY,LANGUAGE,FEEDBACK,RATEUS }
