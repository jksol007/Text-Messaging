...
import com.text.messages.sms.emoji.common.util.extensions.getDisplayName
...
import com.text.messages.sms.emoji.extensions.isVCard
...
class VCardBinder @Inject constructor(
    ...
    override fun bindPart(
        ...
        Observable.just(part.getUri())
            .filter { permissionManager.hasReadSms().also { if (!it) requestSmsPermission() } }
        ...
        if (!message.isMe()) {
            ...
            holder.vCardAvatar.setTint(theme.textPrimary,false)
            ...
            holder.vCardAvatar.setTint(holder.containerView.context.resolveThemeColor(android.R.attr.textColorSecondary),false)
