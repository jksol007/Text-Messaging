...
import com.text.messages.sms.emoji.blocking.BlockingManager
import com.text.messages.sms.emoji.common.ViewModelFactory
import com.text.messages.sms.emoji.util.BillingManagerImpl
import com.text.messages.sms.emoji.common.util.NotificationManagerImpl
import com.text.messages.sms.emoji.common.util.ShortcutManagerImpl
...
import com.text.messages.sms.emoji.listener.ContactAddedListenerImpl
import com.text.messages.sms.emoji.manager.*
import com.text.messages.sms.emoji.mapper.*
import com.text.messages.sms.emoji.repository.*
...
class AppModule(private var application: Application) {
    ...
    @Provides
    @Singleton
    fun provideAdvertiseHandler(): AdvertiseHandler {
        return AdvertiseHandler.getInstance()
    }
