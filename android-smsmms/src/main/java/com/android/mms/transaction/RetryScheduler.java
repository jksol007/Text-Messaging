        ...
        if (cursor != null) {
            try {
                if (cursor.moveToFirst()) {
                    ...
                    PendingIntent operation = PendingIntent.getService(context, 0, service, Build.VERSION.SDK_INT >= Build.VERSION_CODES.S ? PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_ONE_SHOT : PendingIntent.FLAG_ONE_SHOT);
